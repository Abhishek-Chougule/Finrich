...
function get_details_by_cin(cin, reference_docname, rsync = false) {
    frappe.call({
        method: 'finrich.finrich.doctype.finrich_request.finrich_request.get_finrich_data',
        args: {
            "cin": cin,
        ...
        doc.then((finRichSettings) => {
            ...
            frm.add_custom_button(__('FinRich Plus'), function () {
                ...
                frappe.prompt([
                    ...
                    frappe.call({
                        method: 'finrich.finrich.doctype.finrich_request.finrich_request.get_cin_by_name',
                        args: {
